...
export function CreateProductDialog({
  ...
  return (
    <>
      <Tooltip title={noCategories ? "Create a category first." : ""} disableHoverListener={!noCategories}>
        <span>
          <Button variant="contained" onClick={() => setOpen(true)} disabled={noCategories}>
            Create Product
          </Button>
        </span>
      </Tooltip>
      ...
      >
        ...
        <TextField
          ...
          fullWidth
        />
        <ProductImagePicker previewUrl={previewUrl} onFileChange={handleFileChange} error={imageError} />
        <TextField
          label="Sort order"
          type="number"
